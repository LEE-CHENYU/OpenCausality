...
| D: Identity | 5 | Mechanical sensitivity | Computed |
| **Total** | **29** | | |
...
| Rating | Count | Edges |
|--------|-------|-------|
| A | 18 | oil_supply_to_brent, oil_supply_to_fx, oil_demand_to_fx, vix_to_fx, cpi_to_nbk_rate, fx_to_nbk_rate, fx_to_cpi_tradable, fx_to_cpi_nontradable, cpi_to_nominal_income, fx_to_real_expenditure, nbk_rate_to_deposit_cost_sector, loan_portfolio_to_rwa, cor_to_capital, capital_to_k2, rwa_to_k2, nominal_expenditure_to_real, wage_to_nominal_income, import_share_to_iv |
...
| `vix_to_fx` | -0.0332 | 0.1097 | [-0.2482, 0.1818] | 0.7622 | 190 | No | A |
...
| `nominal_expenditure_to_real` | 1.000000 | d(log_real)/d(log_nominal) = 1.0 (deflation identity) | elasticity=1.0 | A |
| `wage_to_nominal_income` | 0.600000 | d(income)/d(wages) = wage_share = 0.60 | wage_share=0.6 | A |
| `import_share_to_iv` | 0.100000 | d(IV)/d(import_share) = avg_fx_change = 0.10 | avg_fx_change=0.1 | A |
...
| `nominal_expenditure_to_real` | not specified | not specified |
| `wage_to_nominal_income` | not specified | not specified |
| `import_share_to_iv` | not specified | not specified |
...
| `shock_to_npl_kspi` | structural | Yes | Yes | NO |  |
| `shock_to_cor_kspi` | structural | Yes | Yes | NO |  |
| `nbk_rate_to_deposit_cost` | diagnostic_only | NO | NO | NO |  |
| `nbk_rate_to_cor` | diagnostic_only | NO | NO | NO |  |
| `expenditure_to_payments_revenue` | diagnostic_only | NO | NO | NO |  |
...
| `nominal_expenditure_to_real` | identity | Yes | Yes | NO |  |
| `wage_to_nominal_income` | identity | Yes | Yes | NO |  |
| `import_share_to_iv` | identity | Yes | Yes | NO |  |
...
| `nbk_rate_to_deposit_cost_sector` | reduced_form | Yes | Yes | NO | nbk_rate_to_deposit_cost |
| `nbk_rate_to_cor_sector` | reduced_form | Yes | Yes | NO | nbk_rate_to_cor |
| `shock_to_npl_kspi_annual` | structural | Yes | Yes | NO | shock_to_npl_kspi |
| `shock_to_cor_kspi_annual` | structural | Yes | Yes | NO | shock_to_cor_kspi |
...
|------|-------------|-----------|-------------|----------------|
| oil_supply_to_brent | IDENTIFIED_CAUSAL | unmeasured_confounding | 5/5 pass | ALLOWED |
...
| vix_to_fx | IDENTIFIED_CAUSAL | unmeasured_confounding | 4/5 pass | ALLOWED |
| cpi_to_nbk_rate | BLOCKED_ID | unmeasured_confounding | 4/5 pass | BLOCKED |
| fx_to_nbk_rate | DESCRIPTIVE | unmeasured_confounding | 5/5 pass | BLOCKED |
...
| shock_to_npl_kspi | IDENTIFIED_CAUSAL | unmeasured_confounding | 5/5 pass | ALLOWED |
| shock_to_cor_kspi | IDENTIFIED_CAUSAL | unmeasured_confounding | 5/5 pass | ALLOWED |
...
| shock_to_npl_kspi_annual | IDENTIFIED_CAUSAL | unmeasured_confounding | 4/5 pass | ALLOWED |
| shock_to_cor_kspi_annual | IDENTIFIED_CAUSAL | unmeasured_confounding | 4/5 pass | ALLOWED |
...
| nbk_rate_to_deposit_cost_sector | REDUCED_FORM | unmeasured_confounding | 5/5 pass | BLOCKED |
| nbk_rate_to_cor_sector | REDUCED_FORM | weak_variation | 4/5 pass | BLOCKED |
| expenditure_to_payments_revenue | DESCRIPTIVE | unmeasured_confounding | 4/5 pass | BLOCKED |
...
| nominal_expenditure_to_real | IDENTIFIED_CAUSAL | none | n/a | ALLOWED |
| wage_to_nominal_income | IDENTIFIED_CAUSAL | none | n/a | ALLOWED |
| import_share_to_iv | IDENTIFIED_CAUSAL | none | n/a | ALLOWED |