...
\begin{enumerate}[leftmargin=*, itemsep=2pt]
    ...
    \item A \textbf{principle-based DAG Critic} that iteratively refines DAG structure via LLM-generated revisions governed by domain-agnostic graph rules, a 6-component quality score, and confidence-gated validation---operating at a higher governance tier than PatchBot (Section~\ref{sec:critic}).
