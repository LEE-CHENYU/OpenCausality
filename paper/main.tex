...
We evaluate \oc{} on a Kazakhstan bank stress-testing case study involving 32 nodes and 21 causal edges, comparing expert-built DAGs against both LLM-extracted and data-driven discovery DAGs, and verifying pipeline reproducibility across 362 tests (Section~\ref{sec:experiments}).
...
\begin{figure}[t]
    ...
    \node[component] at (2.8, 1.5) {30-Rule Issues};
